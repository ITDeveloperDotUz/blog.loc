...
@section('content')
    <div class="page-content container-fluid">
        ...
        <form class="form-edit-add" role="form" action="@if(isset($dataTypeContent->id)){{ route('voyager.books.update', $dataTypeContent->id) }}@else{{ route('voyager.books.store') }}@endif" method="POST" enctype="multipart/form-data">
            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title">
                                <i class="voyager-character"></i> {{ __('voyager::book.title') }}
                                <span class="panel-desc"> {{ __('voyager::book.title_sub') }}</span>
                            </h3>
                    ...
                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">{!! __('voyager::book.description') !!}</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                        <div class="panel-body">
                            ...
                            <textarea class="form-control" name="excerpt">{{ $dataTypeContent->description ?? '' }}</textarea>
                        </div>
                    </div>

                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">{!! __('voyager::book.author') !!}</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                        <div class="panel-body">
                            ...
                            <input type="text" class="form-control" id="author" name="author" placeholder="{{ __('voyager::book.author') }}" value="{{ $dataTypeContent->author ?? '' }}">
                        </div>
                    </div>

                    <div class="panel">
                        <div class="panel-heading">
                            <h3 class="panel-title">{!! __('voyager::book.pub_date') !!}</h3>
                            <div class="panel-actions">
                                <a class="panel-action voyager-angle-down" data-toggle="panel-collapse" aria-hidden="true"></a>
                            </div>
                        </div>
                        <div class="panel-body">
                            <input type="date" class="form-control" id="pub_date" name="pub_date" placeholder="" value="{{ $dataTypeContent->pub_date ?? '' }}">
                        </div>
                    </div>
                    ...
                    <div class="panel">
                        ...
                        <div class="panel-body">
                            @php
                                ...
                                $exclude = ['title','description', 'author', 'pub_date', 'slug', 'category_id', 'author_id', 'featured', 'image', 'meta_description', 'meta_keywords', 'seo_title'];
                            @endphp
                    ...
                    <div class="panel panel panel-bordered panel-warning">
                        ...
                        <div class="panel-body">
                            <div class="form-group">
                                <label for="slug">{{ __('voyager::book.slug') }}</label>
                                @include('voyager::multilingual.input-hidden', [
                                    '_field_name'  => 'slug',
                            ...
                            <div class="form-group">
                                <label for="category_id">{{ __('voyager::book.category') }}</label>
