    ...
    <div class="row">
        <div class="col-md-9">
            ...
            <div class="img-container">
                <img src="{{ Voyager::image(setting('site.logo')) }}" alt="Picture" class="cropper-hidden">
            </div>
        </div>
        <div class="col-md-3">
            <!-- <h3>Preview:</h3> -->
            <div class="docs-preview clearfix">
                <div class="img-preview preview-lg" style="width: 256px; height: 144px;">
                    <img src="{{ Voyager::image(setting('site.logo')) }}" alt="Picture" style="display: block; width: 320px; height: 180px; min-width: 0px !important; min-height: 0px !important; max-width: none !important; max-height: none !important; transform: translateX(-32px) translateY(-10.8321px);"></div>
                <div class="img-preview preview-md" style="width: 128px; height: 72px;">
                    <img src="{{ Voyager::image(setting('site.logo')) }}" alt="Picture" style="display: block; width: 160px; height: 90px; min-width: 0px !important; min-height: 0px !important; max-width: none !important; max-height: none !important; transform: translateX(-16px) translateY(-5.41603px);"></div>
                <div class="img-preview preview-sm" style="width: 64px; height: 36px;">
                    <img src="{{ Voyager::image(setting('site.logo')) }}" alt="Picture" style="display: block; width: 80px; height: 45px; min-width: 0px !important; min-height: 0px !important; max-width: none !important; max-height: none !important; transform: translateX(-8px) translateY(-2.70801px);"></div>
                <div class="img-preview preview-xs" style="width: 32px; height: 18px;">
                    <img src="{{ Voyager::image(setting('site.logo')) }}" alt="Picture" style="display: block; width: 40px; height: 22.5px; min-width: 0px !important; min-height: 0px !important; max-width: none !important; max-height: none !important; transform: translateX(-4px) translateY(-1.35401px);"></div>
            </div>
